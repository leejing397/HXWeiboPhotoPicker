...
- (UILabel *)directionLabel {
    if (_directionLabel == nil) {
        _directionLabel.hidden = YES;
        _directionLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 50, 20)];
        _directionLabel.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.6];
        _directionLabel.textColor = [UIColor whiteColor];
        _directionLabel.font = [UIFont systemFontOfSize:9];
    }
